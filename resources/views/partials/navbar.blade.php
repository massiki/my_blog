...
<nav class="navbar navbar-expand-lg navbar-blog sticky-top">
  <div class="container">
    {{-- Brand --}}
    <a class="navbar-brand d-flex justify-between align-items-center" href="{{ route('home') }}">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        @if ($navCategories->count() > 0)
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->routeIs('category.show') ? 'active' : '' }}" href="#"
