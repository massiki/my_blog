            ...
            <div class="col-lg-8">
                    ...
                    <form action="{{ route('search') }}" method="GET">
                        <div class="input-group input-group-lg">
                            <input type="text" class="form-control" name="q"
                                   placeholder="Ketik kata kunci..." value="{{ $keyword }}"
                                   style="border-radius: 12px 0 0 12px; border: 2px solid var(--gray-200);">
                ...
                @elseif($keyword)
                    <div class="text-center py-5">
                        ...
                        <p style="color: var(--gray-500);">Tidak ada artikel yang cocok dengan "<strong>{{ $keyword }}</strong>". Coba kata kunci lain.</p>
                    </div>
                @endif
            </div>
