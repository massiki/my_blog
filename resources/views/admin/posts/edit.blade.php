        ...
        <div class="admin-form mb-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
              value="{{ old('title', $post->title) }}" placeholder="Masukkan judul artikel..." required>
            @error('title')
          ...
          <div class="mb-3">
            ...
            <trix-editor input="content" class="@error('content') border-danger @enderror"></trix-editor>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
              name="meta_description" rows="2" placeholder="Deskripsi singkat untuk SEO (maks. 160 karakter)" maxlength="160">{{ old('meta_description', $post->meta_description) }}</textarea>
        ...
        <div class="admin-form mb-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags"
              value="{{ old('tags', $tagNames) }}" placeholder="laravel, php, tutorial (pisahkan dengan koma)">
            @error('tags')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="mb-3">
            ...
            @if ($post->thumbnail)
              <div class="mb-2">
                <img src="{{ asset('storage/' . $post->thumbnail) }}" class="thumbnail-preview" alt="Current thumbnail">
                <div class="form-check mt-2">
                  <input class="form-check-input" type="checkbox" name="remove_thumbnail" id="removeThumbnail"
                    value="1">
            ...
            @error('thumbnail')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
            <small class="text-muted">Format: JPEG, PNG, JPG, GIF, WebP. Maks: 2MB. Kosongkan jika tidak ingin
              mengubah.</small>
